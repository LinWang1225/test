...
def export_run(measured:Path,dest:Path,expected:list[dict],thinking:bool)->dict[str,Any]:
    ...
    for i,r in enumerate(rows):
        ...
        rec['is_length_capped']=joined.get('finish_reason')=='length'
    ...
    fields=['dataset','case_id','http_success','finish_reason','is_length_capped','prompt_tokens','completion_tokens',
